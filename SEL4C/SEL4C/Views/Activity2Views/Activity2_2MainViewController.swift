//
//  Activity2_2MainViewController.swift
//  SEL4C
//
...
class Activity2_2MainViewController: UIViewController {
    // MARK: Labels
    ...
    override func viewDidLoad() {
        ...
        instruccionesLabel.text = activities[1].subactivities[1].instructions.text
        instruccionesLabel.numberOfLines = 0
        
        // Format bullets
        var bulletsText: String = ""
        for bullet in activities[1].subactivities[1].instructions.bullets {
            bulletsText += "• " + bullet + "\n"
        }
        ...
        entregaLabel.text = activities[1].subactivities[1].deliverable
