//
//  Activity3_1MainViewController.swift
//  SEL4C
//
...
class Activity3_1MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instruccionesLabel.text = activities[2].subactivities[0].instructions.text
        instruccionesLabel.numberOfLines = 0
        
        // Format bullets
        var bulletsText: String = ""
        for bullet in activities[2].subactivities[0].instructions.bullets {
            bulletsText += "• " + bullet + "\n"
        }
        ...
        entregaLabel.text = activities[2].subactivities[0].deliverable
