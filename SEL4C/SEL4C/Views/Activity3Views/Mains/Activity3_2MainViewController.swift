//
//  Activity3_2MainViewController.swift
//  SEL4C
//
...
class Activity3_2MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instruccionesLabel.text = activities[2].subactivities[1].instructions.text
        instruccionesLabel.numberOfLines = 0
        
        // Format bullets
        var bulletsText: String = ""
        for bullet in activities[2].subactivities[1].instructions.bullets {
            bulletsText += "• " + bullet + "\n"
        }
        ...
        entregaLabel.text = activities[2].subactivities[1].deliverable
